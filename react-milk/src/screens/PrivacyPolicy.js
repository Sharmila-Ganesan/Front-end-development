    ...
    render(){
        return(
            <div className="container p-2 text-dark mb-55">
                <h5 className="text-center mt-3">Sivalingam Milks - Privacy Policy</h5>
                <div className="text-justify  p-3">
                    <p>
                    The term "We” individually and collectively refer to Sivalingam Milks and the terms "You" /"Your" / "Yourself" refer to the users. 
                    </p>
                    <p>
                    This Privacy Policy is an electronic record in the form of an electronic contract formed under the information Technology Act, 2000 and the rules made thereunder and the amended provisions pertaining to electronic documents / records in various statutes as amended by the information Technology Act, 2000. This Privacy Policy does not require any physical, electronic or digital signature.
                    </p>
                    <p>This Privacy Policy is a legally binding document between you and Sivalingam Milks (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and Sivalingam Milks for your use of the website “Website” (defined below).</p>
                    ...
                    <p>To avail certain services on our Websites, users are required to provide certain information for the registration process namely: - a) your name, b) email address, c) sex, d) age, e) PIN code, f) credit card or debit card details g) password etc., and / or your occupation, interests, and the like. The Information as supplied by the users enables us to improve our sites and provide you the most user-friendly experience.</p>
                    <p>
                    ...
                    <p>Redressal Mechanism: Any complaints, abuse or concerns with regards to content and or comment or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing or through email signed with the electronic signature to Mr.Hariharan. ("Grievance Officer"). </p>
                    <p>Mr. Hariharan.S (Grievance Officer)</p>
                    <h6>www.sivalingammilks.com</h6>
                    <br />
                    <h5>Company Name &amp; Address </h5>
                    <p>Ms.Sivalingam Milks,</p>
                    <p>139, Vinobaji Colony,</p>
                    <p>Bodinayakanur,</p>
                    <p>Theni,TamilNadu -625513</p>
