    ...
    render(){
        return(
            <div className="container p-2 text-dark mb-55">
                <h5 className="text-center mt-3">SIVALINGAM MILKS -TERMS AND CONDITIONS</h5>
                <br />
                <div className="text-justify p-3">
                    <p>
                        The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to Sivalingam Milks and the terms "Visitor” ”User” refer to the users. 
                    </p>
                    <p>
                    This page states the Terms and Conditions under which you (Visitor) may visit this website (“Sivalingammilks.com”). 
                    ...
                    The business, any of its business divisions and / or its subsidiaries, associate companies or subsidiaries to subsidiaries or such
                    other investment companies (in India or abroad) reserve their respective rights to revise these Terms and Conditions at any time by 
                    updating this posting. You should visit this page periodically to re-appraise yourself of the Terms and Conditions, 
